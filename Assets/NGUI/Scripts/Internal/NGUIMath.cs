...
static public class NGUIMath
{
	...
	/// velocity = Vector3.Lerp(velocity, Vector3.zero, TimeToShake.deltaTime * 9f);
	/// 
	/// But this code is:
	/// 
	/// target.position += NGUIMath.SpringDampen(ref velocity, 9f, TimeToShake.deltaTime);
	/// </summary>
	...
	/// <summary>
	/// Mathf.Lerp(from, to, TimeToShake.deltaTime * strength) is not framerate-independent. This function is.
	/// </summary>
	...
	/// <summary>
	/// Vector2.Lerp(from, to, TimeToShake.deltaTime * strength) is not framerate-independent. This function is.
	/// </summary>
	...
	/// <summary>
	/// Vector3.Lerp(from, to, TimeToShake.deltaTime * strength) is not framerate-independent. This function is.
	/// </summary>
	...
	/// <summary>
	/// Quaternion.Slerp(from, to, TimeToShake.deltaTime * strength) is not framerate-independent. This function is.
	/// </summary>
